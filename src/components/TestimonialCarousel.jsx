...
const TESTIMONIALS = [
  {
    ...
    role: "Client (Lagos)",
    quote:
      "The caregiver assigned to my mum was professional and kind — we felt safe immediately. Precious Jewels changed our lives.",
  ...
  },
  {
    ...
    role: "Family (Abuja)",
    quote:
      "Prompt, organised and empathetic. The nurse visited daily and kept excellent notes.",
  ...
  },
  {
    ...
    quote:
      "Excellent dementia support. The team trained us and gave patient-centred advice.",
    ...
    <section id="testimonials" className="py-12 bg-slate-800 text-white">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <p className="text-gray-300 mt-2 max-w-2xl">
          Real stories from clients and family members who trusted us with care.
        </p>
